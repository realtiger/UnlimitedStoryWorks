...
function Toast({ className, variant, ...props }: ToastPrimitive.Root.Props & { variant?: 'default' | 'success' | 'warning' | 'error' | 'info' }) {
  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        "group/toast pointer-events-auto absolute right-0 top-0 z-[calc(2000-var(--toast-index))] w-full origin-top rounded-md border bg-popover text-popover-foreground shadow-lg will-change-transform outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
